...
always @(*) begin
	...
	next_state = cur_state;
if (((fsm_stall == 1'd0) && (start == 1'd1)) && (cur_state == legup_0)) begin
	next_state = legup_F_matrix_BB__1_1;
end
else if (cur_state == legup_F_matrix_BB__12_8) begin
	next_state = legup_F_matrix_BB__12_9;
end
else if (((fsm_stall == 1'd0) && (matrix_12_exitcond6 == 1'd1)) && (cur_state == legup_F_matrix_BB__12_9)) begin
	next_state = legup_F_matrix_BB__14_10;
end
else if (((fsm_stall == 1'd0) && (matrix_12_exitcond6 == 1'd0)) && (cur_state == legup_F_matrix_BB__12_9)) begin
	next_state = legup_F_matrix_BB_preheaderpreheader_2;
end
else if (cur_state == legup_F_matrix_BB__14_10) begin
	next_state = legup_F_matrix_BB__14_11;
end
else if (((fsm_stall == 1'd0) && (matrix_14_exitcond == 1'd1)) && (cur_state == legup_F_matrix_BB__14_11)) begin
	next_state = legup_F_matrix_BB__16_12;
end
else if (((fsm_stall == 1'd0) && (matrix_14_exitcond == 1'd0)) && (cur_state == legup_F_matrix_BB__14_11)) begin
	next_state = legup_F_matrix_BB__1_1;
end
else if (cur_state == legup_F_matrix_BB__16_12) begin
	next_state = legup_0;
end
else if (cur_state == legup_F_matrix_BB__1_1) begin
	next_state = legup_F_matrix_BB_preheaderpreheader_2;
end
else if (cur_state == legup_F_matrix_BB_preheader_4) begin
	next_state = legup_F_matrix_BB_preheader_5;
end
else if (cur_state == legup_F_matrix_BB_preheader_5) begin
	next_state = legup_F_matrix_BB_preheader_6;
end
else if (cur_state == legup_F_matrix_BB_preheader_6) begin
	next_state = legup_F_matrix_BB_preheader_7;
end
else if (((fsm_stall == 1'd0) && (matrix_preheader_exitcond2_reg == 1'd1)) && (cur_state == legup_F_matrix_BB_preheader_7)) begin
	next_state = legup_F_matrix_BB__12_8;
end
else if (((fsm_stall == 1'd0) && (matrix_preheader_exitcond2_reg == 1'd0)) && (cur_state == legup_F_matrix_BB_preheader_7)) begin
	next_state = legup_F_matrix_BB_preheader_4;
end
else if (cur_state == legup_F_matrix_BB_preheaderpreheader_2) begin
	next_state = legup_F_matrix_BB_preheaderpreheader_3;
end
else if (cur_state == legup_F_matrix_BB_preheaderpreheader_3) begin
	next_state = legup_F_matrix_BB_preheader_4;
end
end
always @(*) begin
...
always @(*) begin
	legup_mult_matrix_preheader_9_out = legup_mult_matrix_preheader_9_out_actual;
end
always @(*) begin
...
if (reset) begin
	legup_mult_1_unsigned_32_32_1_0_sum = 0;
end
end
always @(*) begin
...
else if (cur_state == legup_F_main_BB__16_13) begin
	finish <= fsm_stall == 1'd0;
end
end
always @(posedge clk) begin
...
else if (cur_state == legup_F_main_BB__0_1) begin
	next_state = legup_F_main_BB__1_2;
end
else if (cur_state == legup_F_main_BB__12_11) begin
	next_state = legup_F_main_BB__12_12;
end
else if (((fsm_stall == 1'd0) && (main_12_exitcond2 == 1'd1)) && (cur_state == legup_F_main_BB__12_12)) begin
	next_state = legup_F_main_BB__16_13;
end
else if (((fsm_stall == 1'd0) && (main_12_exitcond2 == 1'd0)) && (cur_state == legup_F_main_BB__12_12)) begin
...
else if (cur_state == legup_F_main_BB__3_3) begin
	next_state = legup_F_main_BB__3_4;
end
else if (cur_state == legup_F_main_BB__3_4) begin
	next_state = legup_F_main_BB__3_5;
end
else if (((fsm_stall == 1'd0) && (main_3_exitcond5_reg == 1'd1)) && (cur_state == legup_F_main_BB__3_5)) begin
	next_state = legup_F_main_BB__6_6;
end
else if (((fsm_stall == 1'd0) && (main_3_exitcond5_reg == 1'd0)) && (cur_state == legup_F_main_BB__3_5)) begin
	next_state = legup_F_main_BB__3_3;
end
else if (cur_state == legup_F_main_BB__6_6) begin
	next_state = legup_F_main_BB__6_7;
end
else if (((fsm_stall == 1'd0) && (main_6_exitcond == 1'd1)) && (cur_state == legup_F_main_BB__6_7)) begin
	next_state = legup_F_main_BB__8_8;
end
else if (((fsm_stall == 1'd0) && (main_6_exitcond == 1'd0)) && (cur_state == legup_F_main_BB__6_7)) begin
	next_state = legup_F_main_BB__1_2;
end
else if (cur_state == legup_F_main_BB__8_10) begin
	next_state = legup_F_main_BB__12_11;
end
else if (cur_state == legup_F_main_BB__8_8) begin
	next_state = legup_function_callegup_9;
end
else if (((fsm_stall == 1'd0) && (matrix_finish == 1'd1)) && (cur_state == legup_function_callegup_9)) begin
